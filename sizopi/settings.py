...
SECRET_KEY = 'django-insecure-41e&n%8+b0jnsu@m53ov8+va#&6_k&y4+vu!19j@)hw)o^cuks'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'neondb',
        'USER': 'neondb_owner',
        'PASSWORD': 'npg_20uvbgGInROj',
        'HOST': 'ep-withered-pine-a1ddqpl1.ap-southeast-1.aws.neon.tech',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
